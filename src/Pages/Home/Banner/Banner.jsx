            ...
            >
                <div data-src="https://i.ibb.co/g99WwV8/shape-bg.png" className="grid md:grid-cols-2 items-center gap-10 container mx-auto ">
                    <div>
                        ...
                        <h1 className="text-2xl lg:text-5xl font-semibold mt-3 mb-5">Our mission is your financial success</h1>
                    ...
                    <div className="items-end flex">
                        <img  className="rounded-t-full h-96 w-full" src="https://i.ibb.co/ft8yhWW/banner-img-1.jpg" alt="" />
                    </div>
                </div>
                <div data-src="https://i.ibb.co/g99WwV8/shape-bg.png" className="grid md:grid-cols-2 items-center gap-10 container mx-auto ">
                    <div>
                    ...
                    <div className="items-end flex">
                        <img  className="rounded-t-full h-96 w-full" src="https://i.ibb.co/m0pkkFz/banner-img-2.jpg" alt="" />
                    </div>
                </div>
                <div data-src="https://i.ibb.co/g99WwV8/shape-bg.png" className="grid md:grid-cols-2 items-center gap-10 container mx-auto ">
                    <div>
                    ...
                    <div className="items-end flex">
                        <img className="rounded-t-full h-96 w-full" src="https://i.ibb.co/gMhM45Q/banner-img-3.jpg" alt="" />
                    </div>
                </div>
            </AutoplaySlider>
        </div>
