    ...
    <section className=" md:px-16 lg:px-36 mt-11">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5  justify-center">
        <div className="">
          ...
          <div className="bg-[#F8F8F8] shadow p-2 mt-10">
            <p className="bg-gradient-to-r from-[#004F70] to-[#007C9C] p-2 text-[#fff]">
              Accounts
            </p>
            <div className="mt-5">
              <Link
        ...
        <div className="md:px-7">
          ...
          <div className="bg-[#F8F8F8] p-4 h-[150px] flex flex-col justify-center">
            ...
            <Link
              className="text-[#005273] underline"
              to="/dashboard/nexus-customer-service-portal"
            >
              Nexus Customer Service Portal
            </Link>
          </div>
          ...
          <div className="bg-[#F8F8F8] p-4 mt-5 h-[150px] flex flex-col justify-center">
            ...
            <Link className="text-[#005273] underline" to="/contact">
              Nexus Contact Us
            </Link>
