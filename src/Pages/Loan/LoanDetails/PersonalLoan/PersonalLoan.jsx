        ...
        <div>
            <div className='flex items-center h-[200px] md:h-[300px] bg-image bg-[url(https://i.ibb.co/pjJdRBc/Nbl-personal-loan-banner.jpg)]'>
                <div className='w-full max-w-screen-xl mx-auto'>
                    ...
                    <p className='flex gap-1 items-center text-lg font-bold'>Retail Lone <PiCaretDoubleRightDuotone className='text-primary'/> Personal Lone</p>
                </div>
            </div>
            <div className='w-full max-w-screen-xl mx-auto'> 
...
// 
// https://i.ibb.co/k3PmmyK/Nbl-education-loan-banner.jpg