      ...
      >
      {
        ...
        >
          ...
          <div className="flex gap-2 justify-end my-2">
            ...
            /> */}
            <button onClick={handleClick} className="nav-btn py-2 px-4 text-white rounded-md"> Add New Employee</button>
          </div>
        </form>:<div className="mt-32 bg-white text-black rounded w-10/12 md:w-8/12 lg:w-[700px] mx-auto p-8 ">
              <div className="border-1 border-gray-300 rounded-md p-4">
