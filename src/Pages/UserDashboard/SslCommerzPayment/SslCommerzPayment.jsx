...
const SslCommerzPayment = () => {
  ...
  const handleTransfer = () => {
    const transferDataInfo = {
      transferToAccount: selectedAccount,
      transferAmount: transferAmount,
      reason: reason,
      transferType: "sslCommerze",
    };
  ...
  return (
    <div className="mt-20 border rounded-lg bg-white border-gray-400 shadow-md shadow-blue-200">
      {otpSent ? (
        ...
        <div className="mt-5 rounded-lg bg-white">
          <div className="p-4">
            <h1 className="text-md md:text-3xl font-bold text-F mb-5 text-primary">
              Add Money Card Verification with pin
            </h1>
        ...
        // transfer money
        <div className="p-4">
          <h1 className="text-md md:text-3xl font-bold text-primary mb-5">
            Add Fund To Account with SSL Commerze
          </h1>
          <div className="md:flex bg-slate-100 p-2">
            <div className="w-2/3">
          
            <div className="mb-5">
                <h3 className="font-bold text-lg text-primary">To Account</h3>
                <div className="md:flex items-center md:gap-10 ms-2 py-6">
                  ...
                  {balance && (
                    <p className="md:w-1/4">Balance (BDT): {balance}</p>
                  )}
                </div>
                <div className="border border-dashed border-blue-200 mb-5"></div>
              </div>
