...
const MobilTopUpHistory = () => {
    return (
        ...
        <div className='p-4'>
            <h1 className='text-3xl font-bold text-primary'>Mobile Top-up History</h1>
            ...
            <div className=' flex gap-16 bg-slate-100 p-2 rounded-lg ps-6 mt-6'>
                 ...
                 <button className='btn bg-gradient-to-b from-blue-700 to-primary rounded-md text-white '>View</button>
                </div>
