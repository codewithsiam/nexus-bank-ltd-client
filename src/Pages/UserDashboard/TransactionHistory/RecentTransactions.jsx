...
const RecentTransactions = () => {
  ...
  return (
    <div className="block w-full overflow-x-auto bg-white mt-11 rounded-2xl p-7">
      ...
      <h1 className="text-xl my-2">Recent transaction</h1>
          ...
          {transactionData?.map((transaction) => {
            return (
              <tr>
                ...
                <th className="border-t-0 border-b-1 align-middle border-l-0 border-r-0 text-base whitespace-nowrap py-5 text-left text-[#6F7A83] text-sm">
                ...
                <td className="border-t-0 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-5">
                  <p className="bg-[#E8F5E9] py-2 pl-2 pr-4 w-2/4 text-center text-[#337D70] font-bold rounded-lg cursor-pointer">
                    {transaction?.transactionType == "transfer" ? "Sent" : "Cash In"}
                  </p>
                </td>
              </tr>
            );
