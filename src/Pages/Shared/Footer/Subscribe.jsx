...
const Subscribe = () => {
    ...
    return (
        <section className='absolute w-full -top-32 px-3'>
            <div className="container mx-auto nav-btn rounded-lg ">
                <div className="grid md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-1 gap-5">
                    <div className='text-white p-5 py-11'>
                        ...
                        <button className="nav-btn font-semibold mt-5 px-11 font-xl py-3 rounded-xl text-white hover:bg-inherit hover:text-white">Subscribe</button>
                    </div>
